      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Sign in to your Budget Buddy account</p>
          </div>
          ...
          <form onSubmit={handleEmailSignIn} noValidate className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="login-identifier" className="block text-sm font-medium text-foreground">
            ...
            <button
              type="submit"
              disabled={isSubmitting || isGoogleSubmitting}
              className="mt-2 w-full rounded-lg py-2.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <Link
            to="/phone-signin"
            className="mt-2 flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted"
          >
